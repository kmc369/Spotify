import { ElementRef, AfterContentInit, TemplateRef, QueryList, NgZone, EventEmitter, ChangeDetectorRef, SimpleChanges, Renderer2, AfterViewInit } from '@angular/core';
import * as i0 from "@angular/core";
import * as i1 from "@angular/common";
import * as i2 from "primeng/api";
import * as i3 from "primeng/ripple";
export declare class Carousel implements AfterContentInit, AfterViewInit {
    el: ElementRef;
    zone: NgZone;
    ...
    constructor(el: ElementRef, zone: NgZone, cd: ChangeDetectorRef, renderer: Renderer2, document: Document);
