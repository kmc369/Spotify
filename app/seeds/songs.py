...
def seed_songs():
    ...
    song37 = Song(name="Black Dog", time="4:55", type="Rock", artist_id=4, album_id=9, user_id=2, audio_url="https://spotify-audio-bucket.s3.amazonaws.com/onlymp3.to+-+Led+Zeppelin+Black+Dog+lyrics+-NwBtLnq0_Ic-192k-1698788683.mp3")
    
    song38 = Song(name="The Great Escape", time="3:12", type="Pop", artist_id=9, album_id=10, user_id=3, audio_url="https://spotify-audio-bucket.s3.amazonaws.com/onlymp3.to+-+Boys+Like+Girls+The+Great+Escape-JGPgxoIPY6Q-192k-1698789194.mp3")
    song39 = Song(name="Hero/Heroine", time="3:51", type="Pop", artist_id=9, album_id=10, user_id=2, audio_url="https://spotify-audio-bucket.s3.amazonaws.com/onlymp3.to+-+Hero+Heroine+Boys+Like+Girls+LYRICS-15ukJxqPvuE-192k-1698789059.mp3")
    ...
    song41 = Song(name="Time to Dance", time="3:22", type="Alternative", artist_id=10, album_id=11, user_id=2, audio_url="https://spotify-audio-bucket.s3.amazonaws.com/onlymp3.to+-+panic__at_the_disco___time_to_dance__official_audio_-JfUug-R7M5g-192k-1698789427.mp3")
    
    song42 = Song(name="Hotel California", time="6:30", type="Rock", artist_id=11, album_id=12, user_id=2, audio_url="https://spotify-audio-bucket.s3.amazonaws.com/onlymp3.to+-+Hotel+California+Lyrics+The+Eagles-ESj7dNMptXs-192k-1698789778.mp3")
    song43 = Song(name="New Kid in Town", time="5:04", type="Rock", artist_id=11, album_id=12, user_id=3, audio_url="https://spotify-audio-bucket.s3.amazonaws.com/onlymp3.to+-+New+Kid+in+Town+2013+Remaster+-L4LxavmC4_4-192k-1698789729.mp3")
    
    song44 = Song(name="What's Love Got to Do with It", time="3:49", type="Rock", artist_id=5, album_id=13, user_id=2, audio_url="https://spotify-audio-bucket.s3.amazonaws.com/onlymp3.to+-+What+s+Love+Got+to+Do+with+It+2015+Remaster+-1avX1lX7gSs-192k-1698790111.mp3")
    song45 = Song(name="We Don't Need Another Hero (Thunderdome)", time="4:15", type="Rock", artist_id=5, album_id=13, user_id=2, audio_url="https://spotify-audio-bucket.s3.amazonaws.com/onlymp3.to+-+We+Don+t+Need+Another+Hero+Thunderdome+-kDERlmd2NS4-192k-1698790100.mp3")
    ...
    song47 = Song(name="Thnks fr th Mmrs", time="3:23", type="Alternative", artist_id=6, album_id=14, user_id=2, audio_url="https://spotify-audio-bucket.s3.amazonaws.com/Fall+Out+Boy+-+Thnks+Fr+Th+Mmrs+(Audio)+(HD).mp3")
    ...
    song49 = Song(name="Hey there Delilah", time="3:40", type="Pop", artist_id=9, album_id=15, user_id=2, audio_url="https://spotify-audio-bucket.s3.amazonaws.com/Plain+White+T's+-+Hey+There+Delilah.mp3")
    
    podcast1 = Song(name="climate crisis", time="11:36", type="sciene", artist_id=17, album_id=16, user_id=2, audio_url="https://spotify-audio-bucket.s3.amazonaws.com/onlymp3.to+-+John+Doerr+and+Ryan+Panchadsaram+An+action+plan+for+solving+the+climate+crisis+TED+Countdown-ZrdgSp-OVpM-192k-1698777774.mp3")
    podcast2 = Song(name="Wind Energy Could Power Earth", time="10:36", type="sciene", artist_id=17, album_id=16, user_id=3, audio_url="https://spotify-audio-bucket.s3.amazonaws.com/onlymp3.to+-+How+Wind+Energy+Could+Power+Earth+...+18+Times+Over+Dan+J%C3%B8rgensen+TED+Countdown-adJnm7Yopdo-192k-1698778388.mp3")
    podcast3 = Song(name="Billion-Dollar Pollution Solution Humanity", time="13:36", type="sciene", artist_id=17, album_id=16, user_id=2, audio_url="https://spotify-audio-bucket.s3.amazonaws.com/onlymp3.to+-+The+Billion+Dollar+Pollution+Solution+Humanity+Needs+Right+Now+Stacy+Kauk+TED-IGIT-vENgaQ-192k-1698778602.mp3")

    podcast4 = Song(name="Buying Twitter X", time="13:36", type="world", artist_id=18, album_id=17, user_id=2, audio_url="https://spotify-audio-bucket.s3.amazonaws.com/onlymp3.to+-+Elon+Musk+on+Buying+Twitter+and+Turning+It+Into+X-N8Nf56srwcA-192k-1698779242.mp3")
    podcast5 = Song(name="America is Collapsing", time="5:36", type="world", artist_id=18, album_id=17, user_id=3, audio_url="https://spotify-audio-bucket.s3.amazonaws.com/onlymp3.to+-+Jimmy+Carr+Doesn+t+Think+America+is+Collapsing+Like+the+Roman+Empire-frCnYp9Wwrg-192k-1698779805.mp3")
    
    podcast6 = Song(name="Water on the Moon", time="7:36", type="science", artist_id=19, album_id=18, user_id=2, audio_url="https://spotify-audio-bucket.s3.amazonaws.com/onlymp3.to+-+Why+Artemis+III+Is+Going+To+The+Lunar+South+Pole+Neil+deGrasse+Tyson+Explains+-4tOvImrGM9g-192k-1698780295.mp3")
    podcast7 = Song(name="Inside Objects", time="3:36", type="science", artist_id=19, album_id=18, user_id=3, audio_url="https://spotify-audio-bucket.s3.amazonaws.com/onlymp3.to+-+Why+Artemis+III+Is+Going+To+The+Lunar+South+Pole+Neil+deGrasse+Tyson+Explains+-4tOvImrGM9g-192k-1698780295.mp3")

    podcast8 = Song(name="Warren Buffett", time="3:36", type="finance", artist_id=20, album_id=19, user_id=1, audio_url="https://spotify-audio-bucket.s3.amazonaws.com/onlymp3.to+-+Warren+Buffett+You+Only+Need+To+Know+These+7+Rules-63oF8BOMMB8-192k-1698781092.mp3")
    podcast9 = Song(name="The Collapse", time="10:36", type="finance", artist_id=20, album_id=19, user_id=2, audio_url="https://spotify-audio-bucket.s3.amazonaws.com/onlymp3.to+-+DANGER+It+Begins...+Jim+Rickards+-u-mIjQW4qvU-192k-1698781316.mp3")
    ...
    podcast11 = Song(name="Black Hole Sounds", time="0:36", type="science", artist_id=21, album_id=20, user_id=3, audio_url="https://spotify-audio-bucket.s3.amazonaws.com/onlymp3.to+-+What+do+black+holes+sound+like+NASA+releases+recording+of+black+hole+in+distant+galaxy-NWBkZ3bMSV0-192k-1698781941.mp3")

    podcast12 = Song(name="Be The Change", time="8:36", type="motivation", artist_id=22, album_id=8, user_id=2, audio_url="https://spotify-audio-bucket.s3.amazonaws.com/onlymp3.to+-+be_the_change_you_want_to_see_in_the_world___motivational_speech_for_2023_by_corey_d_jones-gbRe1bI_EbE-192k-1698783126.mp3")
    podcast13 = Song(name="Discipline 7000 hours", time="10:41", type="motivation", artist_id=22, album_id=8, user_id=2, audio_url="https://spotify-audio-bucket.s3.amazonaws.com/onlymp3.to+-+What+7000+HOURS+of+DISCIPLINE+Looks+Like-mQZRs5tXWN4-192k-1698783227.mp3")
