...
def seed_songs():
    ...
    song1 = Song(name="Over My Dead Body",  time="4:32",type="R&B" ,artist_id=1,user_id=2,album_id=2,audio_url="https://spotify-audio-bucket.s3.amazonaws.com/onlymp3.to+-+Over+My+Dead+Body-PMk8L9FNqnY-192k-1697895874.mp3", playlist_id=1)
    ...
    song4 = Song(name="Crew Love", time="3:29", type="R&B" ,artist_id=1,user_id=4,album_id=2,audio_url="https://spotify-audio-bucket.s3.amazonaws.com/onlymp3.to+-+Crew+Love-WL-3zvnUomk-192k-1697895793.mp3", playlist_id=1)
    ...
    song6 = Song(name="Supermodel", time="3:59", type="R&B", artist_id=8, album_id=6, user_id=3, audio_url="https://spotify-audio-bucket.s3.amazonaws.com/onlymp3.to+-+Supermodel-tZeKZNcLUpc-192k-1697896710.mp3", playlist_id=1)
    song7 = Song(name="Love Galore (featuring Travis Scott)", time="4:35", type="R&B", artist_id=8, album_id=6, user_id=2, audio_url="https://spotify-audio-bucket.s3.amazonaws.com/onlymp3.to+-+SZA+Love+Galore+Alt+Version+Audio+-5YOEzmyM-Zs-192k-1697896789.mp3", playlist_id=1)
    ...
    song13 = Song(name="The Thing That Should Not Be", time="6:36", type="Metal", artist_id=3, album_id=8, user_id=3, audio_url="https://spotify-audio-bucket.s3.amazonaws.com/onlymp3.to+-+The+Thing+That+Should+Not+Be+Remastered+-DoHk21aGHas-192k-1697898009.mp3", playlist_id=1)
    ...
    song20 = Song(name="Where Are Ü Now", time="4:10", type="Pop", artist_id=13, album_id=1, user_id=4, audio_url="https://spotify-audio-bucket.s3.amazonaws.com/onlymp3.to+-+Justin+Bieber+Where+Are+U+Now+Lyrics+with+Skrillex+and+Diplo-3ek2pU4m6Js-192k-1697900457.mp3", playlist_id=1)
