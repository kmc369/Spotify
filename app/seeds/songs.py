...
def seed_songs():
    ...
    podcast4 = Song(name="Buying Twitter X", time="13:36", type="world", artist_id=18, album_id=17, user_id=1, audio_url="https://spotify-audio-bucket.s3.amazonaws.com/onlymp3.to+-+Elon+Musk+on+Buying+Twitter+and+Turning+It+Into+X-N8Nf56srwcA-192k-1698779242.mp3")
    podcast5 = Song(name="America is Collapsing", time="5:36", type="world", artist_id=18, album_id=17, user_id=1, audio_url="https://spotify-audio-bucket.s3.amazonaws.com/onlymp3.to+-+Jimmy+Carr+Doesn+t+Think+America+is+Collapsing+Like+the+Roman+Empire-frCnYp9Wwrg-192k-1698779805.mp3")
    ...
    podcast9 = Song(name="The Collapse", time="10:36", type="finance", artist_id=20, album_id=19, user_id=1, audio_url="https://spotify-audio-bucket.s3.amazonaws.com/onlymp3.to+-+DANGER+It+Begins...+Jim+Rickards+-u-mIjQW4qvU-192k-1698781316.mp3")
