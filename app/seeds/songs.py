...
def seed_songs():
    ...
    song12 = Song(name="Master of Puppets", time="8:35", type="Metal", artist_id=3, album_id=8, user_id=2, audio_url="https://spotify-audio-bucket.s3.amazonaws.com/onlymp3.to+-+Metallica+Master+Of+Puppets+Lyrics+-xnKhsTXoKCI-192k-1697898103.mp3",playlist_id=1)
    ...
    song31 = Song(name="34+35", time="2:53", type="Pop", artist_id=16, album_id=5, user_id=2, audio_url="https://spotify-audio-bucket.s3.amazonaws.com/onlymp3.to+-+34+35+Ariana+Grande+Lyrics+-7sWO2cHTQx4-192k-1697903000.mp3",playlist_id=1)
